...
module.exports = function(config) {
    ...
    var misc_db = new Store(config.path + '/misc', {saveId: 'id'});
    ...
    var storage = {
        ...
        misc: {
            get: function(misc_id, cb) {
                misc_db.get(misc_id, cb);
            },
            save: function(misc, cb) {
                misc_db.save(misc.id, misc, cb);
            },
            delete: function(misc_id, cb) {
                misc_db.delete(misc_id, cb);
            },
            all: function(cb) {
                misc_db.all(objectsToList(cb));
            }
        }
    };
